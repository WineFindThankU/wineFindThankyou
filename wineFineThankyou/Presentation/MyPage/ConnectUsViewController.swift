...
class ConnectUsViewController: UIViewController {
    ...
    private func additionalTxtView(_ upperView: UITextField){
        ...
        txtView.textContainerInset = UIEdgeInsets(top: 5, left: 5, bottom: 5, right: 5);
    }
...
extension ConnectUsViewController: MFMailComposeViewControllerDelegate{
    @objc
    private func sendEmail() {
        if MFMailComposeViewController.canSendMail() {
            ...
            composeViewController.setSubject("[와인파인땡큐] 문의 및 의견 - \(mailTitle ?? "")")
